...
public class MergeRowsMeta extends BaseStepMeta implements StepMetaInterface
{
	...
	public void setReferenceStepMeta(StepMeta referenceStepMeta) {
		this.referenceStepMeta = referenceStepMeta;
	}
	...
	public void setCompareStepMeta(StepMeta compareStepMeta) {
		this.compareStepMeta = compareStepMeta;
	}
    ...
    public StepIOMetaInterface getStepIOMeta() {
    	if (ioMeta==null) {
	    	...
	    	ioMeta.addStream( new Stream(StreamType.INFO, referenceStepMeta, BaseMessages.getString(PKG, "MergeRowsMeta.InfoStream.FirstStream.Description"), StreamIcon.INFO, null) );
	    	ioMeta.addStream( new Stream(StreamType.INFO, compareStepMeta, BaseMessages.getString(PKG, "MergeRowsMeta.InfoStream.SecondStream.Description"), StreamIcon.INFO, null) );
    	}
