...
public class StreamLookupMeta extends BaseStepMeta implements StepMetaInterface
{
    ...
    private StepMeta lookupStepMeta;
    
    

	public StepMeta getLookupStepMeta() {
		return lookupStepMeta;
	}

	public void setLookupStepMeta(StepMeta lookupStepMeta) {
		this.lookupStepMeta = lookupStepMeta;
	}
    ...
    public StepIOMetaInterface getStepIOMeta() {
    	if (ioMeta==null) {
	    	...
	    	StreamInterface stream = new Stream(StreamType.INFO, lookupStepMeta, BaseMessages.getString(PKG, "StreamLookupMeta.InfoStream.Description"), StreamIcon.INFO, null);
